...
public:
    // Constructor
	Joystick(uint8_t PinNumber, uint8_t Polar=FORWARD_WHEN_POSITIVE, uint8_t range=8, bool Revert = false, uint32_t SamplingPeriod = 5, int32_t DeadBand=20, uint32_t mark=170);
